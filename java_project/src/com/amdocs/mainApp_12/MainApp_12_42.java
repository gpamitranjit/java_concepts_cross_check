 ...
 *
 */
public class MainApp_12_42 {

	public static void main(String[] args) {
//		the following code gets the highest earner by gender
		List<Employee> persons = MainApp_12_42.persons();
		Map<Employee.Gender, Employee> highestEarnerByGender = persons
				.stream()
